...
# Chaincode gymedical related
GYMEDICAL_NAME="gymedical"
GYMEDICAL_PATH="gymedical"
GYMEDICAL_INIT_ARGS=''
GYMEDICAL_UPGRADE_ARGS=''
GYMEDICAL_INVOKE_ARGS=''
GYMEDICAL_QUERY_ARGS=''

# Chaincode map related
GYMEDICAL_MAP_NAME="map"
GYMEDICAL_MAP_PATH="examples/chaincode/go/map"
GYMEDICAL_MAP_INIT_ARGS='{"Args":["init",""]}'
GYMEDICAL_MAP_UPGRADE_ARGS='{"Args":["upgrade",""]}'
GYMEDICAL_MAP_INVOKE_ARGS='{"Args":["invoke","put","key","value"]}'
GYMEDICAL_MAP_QUERY_ARGS='{"Args":["get","key"]}'

# unique chaincode params
GYMEDICAL_INIT_VERSION=1.2
GYMEDICAL_UPGRADE_VERSION=1.3
